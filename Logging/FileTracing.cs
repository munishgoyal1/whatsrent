...
namespace WhatsRent.Platform.Logging
{
    ...
    public static class FileTracing
    {
        ...
        static FileTracing()
        {
            ...
            mLogFile = SystemUtils.GetStockLogsFileName();
            ...
            Logger.Initialize(mErrorFile, "WhatsRent", tracerLockObject);
        ...
        public static void SetTraceFilename(string filePath, string traceFileName)
        {
            lock (tracerLockObject)
            {
                ...
                Logger.ReInitialize(mErrorFile, "WhatsRent", tracerLockObject);
                sw = new StreamWriter(mLogFile);
                sw.AutoFlush = true;
            }
        }
